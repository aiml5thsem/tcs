...
Usage Examples:
    ...
    python web_scraper.py --url https://myapp.com --mode auto
    
    # Manual mode - you navigate, script extracts on Enter
    python web_scraper.py --url https://myapp.com --mode manual
    
    # Hybrid mode - auto-discovers, then lets you add/remove links
    python web_scraper.py --url https://myapp.com --mode hybrid
    
    # Use existing Chrome (no playwright browser needed)
    python web_scraper.py --url https://myapp.com --mode auto --use-chrome /path/to/chrome
    
    # Full configuration
    python web_scraper.py --url https://myapp.com --mode auto --max-pages 500 --max-depth 8 --use-chrome auto
...
async def main():
    ...
    parser = ArgumentParser(
        ...
        formatter_class=lambda prog: ArgumentParser.RawDescriptionHelpFormatter(
            prog, max_help_position=40
        ),
        epilog="""
Examples:
  Auto mode (fully automatic):
    python web_scraper.py --url https://docs.myorg.com --mode auto
  
  Manual mode (you navigate, script extracts):
    python web_scraper.py --url https://internal.myorg.com --mode manual
  
  Hybrid mode (auto-discover, then customize):
    python web_scraper.py --url https://wiki.myorg.com --mode hybrid
  ...
  Use existing Chrome (avoids playwright browser download):
    ...
    python web_scraper.py --url https://myorg.com --mode auto --use-chrome "/path/to/chrome"
        """
    )
