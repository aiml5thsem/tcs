...
### Intelligent URL Ordering

The scraper now uses **intelligent URL sorting** to crawl documentation in logical order:

**Priority Order:**
1. **Home/Welcome pages** - index, home, welcome, intro, overview
2. **Getting Started** - getting-started, quickstart, tutorial, guide
3. **Installation** - installation, install, setup
4. **Core Concepts** - basics, fundamentals, core, concepts
5. **Usage Guides** - usage, using, working
6. **Features** - features, capabilities
7. **API Reference** - api, reference, docs
8. **Advanced Topics** - advanced, deep-dive
9. **Deployment** - deployment, production
10. **Help** - troubleshooting, faq, help
11. **Updates** - changelog, updates, releases
12. **Development** - contributing, development

**Example Output:**
```
📋 Crawl order (first 10):
  1. https://docs.myorg.com/welcome
  2. https://docs.myorg.com/getting-started/quickstart
  3. https://docs.myorg.com/installation
  4. https://docs.myorg.com/core-concepts
  5. https://docs.myorg.com/usage-guide
  6. https://docs.myorg.com/api/reference
  7. https://docs.myorg.com/deployment
  8. https://docs.myorg.com/changelog
  ... and 42 more

🤖 AUTO MODE - Automatic Crawling
  📄 [1/100] Crawling (depth 0): https://docs.myorg.com/welcome
  📄 [2/100] Crawling (depth 0): https://docs.myorg.com/getting-started/quickstart
  📄 [3/100] Crawling (depth 0): https://docs.myorg.com/installation
```

This ensures your documentation follows a natural reading order, perfect for LLM context!
